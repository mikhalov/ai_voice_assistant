...
public class OpenAIServiceImpl implements OpenAIService {
    ...
    private <T> T performPostRequest (
        ...
        return webClient.post()
                ...
                .bodyValue(bodyValue)
                .retrieve()
                .onStatus(HttpStatusCode::isError, OpenAIServiceImpl::handleError)
    ...
    @NotNull
    private static RetryBackoffSpec retryAfterTooManyRequests() throws TooManyRequestsException {
